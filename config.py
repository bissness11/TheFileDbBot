...
PICS = (environ.get('PICS', 'https://telegra.ph/file/dbf60de10c92ee66fba54.jpg')).split() # Bot Start Picture
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://t.me/kipppbot?start") # For More Information Check Video On Yt - @Tech_VJ
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://exceptional-brittaney-bissness-13593939.koyeb.app/")
